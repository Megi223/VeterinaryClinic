        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (this.ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await this.userManager.AddToRoleAsync(user, GlobalConstants.OwnerRoleName);
                    string photoUrl = await this.cloudinaryService.UploudAsync(this.Input.Image);
                    await this.ownersService.CreateOwnerAsync(user, this.Input.FirstName, this.Input.LastName, photoUrl, this.Input.City);
